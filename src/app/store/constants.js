...
export const GET_COMPANY_MATCHES_ERROR = 'GET_COMPANY_MATCHES_ERROR';
...
export const GET_STUDENT_MATCHES = 'GET_STUDENT_MATCHES';
export const GET_STUDENT_MATCHES_FAILURE = 'GET_STUDENT_MATCHES_FAILURE';
